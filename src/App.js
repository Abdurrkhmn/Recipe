...
function App() {
    ...
    return (
      <div className="flex">
        <Navbar />
        <div className="w-full absolute mt-20 flex items-center justify-center z-[-1] bg-[url('https://images.unsplash.com/photo-1543353071-873f17a7a088?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80')] h-3/5 bg-center bg-cover">
          <form className="h-10 flex justify-center w-64">
            <input 
              type="text" 
              className="shadow-md rounded-l-full font-[Poppins] text-gray-800 pl-2" placeholder="What are you looking for?"
              value={search}
              onChange={(e) => setSearch(e.target.value)}
              />
              <div class="fas fa-search"> </div>
            <button 
              className="bg-zinc-400 w-44 rounded-r-full hover:bg-zinc-500 " 
              type="submit"
              onClick={handleClick}
            >search
            </button>
        ...
        <div className = "absolute p-8 text-2xl text-gray-600 font-semibold top-3/4 w-full z-[-1]">
          <h1>Find your Recipe quickly!</h1>
