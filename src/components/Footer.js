...
const Footer = () => {
  return (
    <div className="absolute bottom-0 bg-slate-900 text-white inset-x-0 md:text-md text-sm py-4 text-center font-mono mt-20">
      ...
      <h1 className = " text-lg">2023 © Команда «Рецепты»</h1>
      ...
      <h2 className = "mt-4">Команда из <span className="text-yellow-400">цифровая экономика</span> и <span className="text-yellow-400">экономика организаци</span></h2>
    </div>
  )
}
